              ...
              return (
                    ...
                    >
                        <div className={`${className || ''} 
                            ${selected ? 'font-light	text-white bg-blue-600 dark:bg-yellow-600' : ''}  
                        ...
                        >
                            <div className="font-light	text-lg">{tag.name} </div>
                            {tag.count
                              ? (
                                    <sup className="font-light	relative ml-1">{tag.count}</sup>
                                )
                              : (
                                    <></>
                                )}
