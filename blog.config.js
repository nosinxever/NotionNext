...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '11a04b7888e0803da49af16b26aa75a9,en:11a04b7888e0803da49af16b26aa75a9',
  ...
  GREETING_WORDS:
    ...
    'Hi，I am practicing writing , Hi，I am nobody, Hi，I am a learner,welcome to my space🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'D00dle', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'I am practicing writing', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://D00dle.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, Post', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,facebook,twitter,telegram,linkedin', // 分享的服務，按顺序显示,逗号隔开
